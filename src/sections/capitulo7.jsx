  ...
  return (
      <div className="img-box">
        <div className="img-merge">
          <img
            className="line-img"
            src="/images/ilustraciones/Ilustracion21.png"
        ...
        <div className="img-merge">
          <img
            className="line-img"
            src="/images/ilustraciones/Ilustracion22.png"
            alt="Ilustracion linea"
          />
          <img
            className="color-img"
        ...
        <div className="img-merge">
          <img
            className="line-img"
            src="/images/ilustraciones/Ilustracion23.png"
            alt="Ilustracion linea"
          />
          <img
            className="color-img"
        ...
        <div className="img-merge">
          <img
            className="line-img"
            src="/images/ilustraciones/Ilustracion24.png"
            alt="Ilustracion linea"
          />
          <img
            className="color-img"
